...
const Footer = () => {
  const listSchedule = useSelector(state => state.booking.List_Schedule_Cinema)
  return (
      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium">Các bên liên quan</p>
            <div  >
              {listSchedule.map(item => {
                return <span className='mx-2'>
                  <img alt='' width={"70px"} src={item.logo} ></img>
                </span>
              })}
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium">Ứng dụng</p>
           <img></img>
          </div>
        </div>
